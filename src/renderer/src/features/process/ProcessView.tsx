...
const PipelineFlowChart = lazy(() => import('./PipelineFlowChart'))
      ...
      <div className="max-w-[1400px] mx-auto p-6 space-y-8">
        ...
        >
          ...
          <p className="text-xs mt-1" style={{ color: C.textSub }}>
            클로드 코드의 스킬을 개발 상황에 맞게 조합하는 가이드
          </p>
        ...
        {/* 2. 에이전트 파이프라인 플로우 (React Flow) */}
        <Suspense
          fallback={
            <div className="rounded-xl p-8 flex items-center justify-center" style={{ backgroundColor: C.card, border: `1px solid ${C.border}`, height: 500 }}>
              <span className="text-xs animate-pulse" style={{ color: C.textDim }}>파이프라인 로딩 중...</span>
            </div>
          }
        >
          <PipelineFlowChart />
